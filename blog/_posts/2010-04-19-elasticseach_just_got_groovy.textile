...
p. Just pushed into master (upcoming 0.7 release) a "Groovy":http://groovy-lang.org/ client wrapper on-top of the "Java API":/guide/reference/java-api/ elasticsearch provides.
